...
The current public Linux build is **Work Day with God 1.2.2 for Linux x64**. It remains an experimental testing prerelease and is not part of the stable Windows 1.4.4 or Android 1.0.1 release lines. No newer Linux package has been published.
