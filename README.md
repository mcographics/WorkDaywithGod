...
The current stable release is **Work Day with God 1.4.1a for Windows x64**. Download `Work-Day-with-God-Setup-1.4.1a.exe` from the [latest GitHub release](https://github.com/mcographics/WorkDaywithGod/releases/latest) and run it.
